...
import { faAngleDown, faAngleUp, faArrowDown, faArrowUp, faEdit, faEllipsisH, faExternalLinkAlt, faEye, faPhone } from '@fortawesome/free-solid-svg-icons';
...
import { CompareRounded, DomainDisabled } from "@material-ui/icons";
...
export const TransactionsTable = () => {
  ...
  */
  ...
  const TableRow = (props) => {
    ...
    const { id, email, amount, lDate, tDate, IVA, NIF, company, webpage, number } = props;
    console.log(props)
    ...
    return (
      <tr>
        ...
        <td>
          <span className="fw-normal">
            ${parseFloat(props['Coste']).toFixed(2)}
          </span>
        </td>
        <td>
          <span className="fw-normal">
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item>
                <FontAwesomeIcon icon={faEdit} className="me-2" /> Email
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </td>
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">Input Date</th>
              <th className="border-bottom">Issue Date</th>
              <th className="border-bottom">IVA</th>
              <th className="border-bottom">NIF</th>
              <th className="border-bottom">Company</th>
              <th className="border-bottom">More</th>
            </tr>
          </thead>
          <tbody>
            {Object.keys(tickets).map(t => <TableRow key={t} {...tickets[t]} />)}
          </tbody>
        </Table>
      </Card.Body>
    </Card>
